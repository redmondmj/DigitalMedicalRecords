...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/U3P0NQW1M/F7ESKBJPQ/eye.php?nojsmode=1" /></noscript>
...
(function() {
	...
	<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/webpack.manifest.10e5f7392054b791617c.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U2LQN1NRX");
							sb('set', 'user_' + "batch", "signup_api");
							sb('set', 'user_' + "created", "2016-10-07");
						sb('set', 'name_tag', "nsccit" + '/' + "andrewcrowe");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
		...
		window.addEventListener('load', function() {
	        ...
	        <title>eye.php | NSCC IT Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://avatars.slack-edge.com/2017-05-12/182754187922_199c9f0763657b6e66ff_192.png')" data-thumb-size="48" data-member-id="U2LQN1NRX"></span>
					<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2017-05-12/182754187922_199c9f0763657b6e66ff_72.png')" data-thumb-size="36" data-member-id="U2LQN1NRX"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">andrewcrowe</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/24778574065?crumb=s-1507219133-4c8fe8fac2-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<li class="active">
	<a href="https://nsccit.slack.com/home" target="https://nsccit.slack.com/">
					<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
							<i class="team_icon small default" >NI</i>
				<span class="switcher_label team_name">NSCC IT</span>
	</a>
...
<p class="print_only">
	...
	Created by matttpat on Thursday, October 5, 2017 at 0:51 PM
	</strong><br />
	<span class="subtle_silver break_word">https://nsccit.slack.com/files/U3P0NQW1M/F7ESKBJPQ/eye.php</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T0QNWGW1X-F7ESKBJPQ-531459659d" target="new">https://slack-files.com/T0QNWGW1X-F7ESKBJPQ-531459659d</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		5KB HTML snippet created on <span class="date">October 5, 2017</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">&lt;!DOCTYPE html&gt;
&lt;html lang=&quot;en&quot;&gt;
    ...
    &lt;div class=&quot;site-wrapper&quot;&gt;
        ...
        &lt;div class=&quot;site-wrapper-inner&quot;&gt;
            ...
            &lt;div class=&quot;cover-container&quot;&gt;
                ...
                &lt;/div&gt;
                &lt;!-- Main Content Area --&gt;
                &lt;div style=&quot;border-style: solid; border-width: 3px; border-color: white; border-radius: 15px;&quot;&gt;
                    
                    &lt;label class=&quot;col-sm-4 control-label&quot;&gt;Full Name&lt;/label&gt;
                    &lt;label class=&quot;col-sm-2 control-label&quot;&gt;Age&lt;/label&gt;
                    &lt;label class=&quot;col-sm-2 control-label&quot;&gt;Village&lt;/label&gt;
                    &lt;label class=&quot;col-sm-2 control-label&quot;&gt;Case #&lt;/label&gt;
                    &lt;p class=&quot;col-sm-12 control-label&quot;&gt;Text Here&lt;/p&gt;
                      &lt;div class=&quot;col-sm-12&quot;&gt;
...
&lt;/html&gt;</pre>
	...
	<form action="https://nsccit.slack.com/files/U3P0NQW1M/F7ESKBJPQ/eye.php"
			id="file_comment_form"
							class="comment_form clearfix"
						method="post">
					<a href="/team/U2LQN1NRX" class="member_preview_link" data-member-id="U2LQN1NRX" >
				<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2017-05-12/182754187922_199c9f0763657b6e66ff_72.png')" data-thumb-size="36" data-member-id="U2LQN1NRX"></span>
			</a>
				<input type="hidden" name="addcomment" value="1" />
		<input type="hidden" name="crumb" value="s-1507219133-0d63713ec6-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U2LQN1NRX',
		team_id: 'T0QNWGW1X',
		visitor_uid: ".81ym8z754q4oww4o8wg0kg8ow",
		no_login: false,
		version_ts: '1507218463',
		version_uid: '8d9896f1c25abf9d20514bebd9ba5e22a45b5b82',
	...
	codemirror_files: {
		...
		feature_enterprise_external_id_conflict_error: false,
		...
		feature_convo_details_timezone: false,
	...
	// client boot data
		...
		boot_data.ms_connect_url = "wss:\/\/lbmulti-jcQY.lb.slack-msgs.com\/?flannel=2&token=xoxs-24778574065-88838056881-232495569093-8dc32e2554";
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_required_ts.a0b9861286178fcf07a7.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_web.51860257ab0a93c2fef5.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-secondary_a_required.e136e8e1a9a8f452b6cd.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-secondary_b_required.8c9a0fa596dcd499fd23.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "application" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/application.d3d417e75805db337691.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/codemirror_load.76d72167bd995cf5b4ba.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
		...
		<script type="text/javascript">
				TS.clog.setTeam('T0QNWGW1X');
				TS.clog.setUser('U2LQN1NRX');
			</script>
	...
	<!--
		...
		boot_data.file = {"id":"F7ESKBJPQ","created":1507218668,"timestamp":1507218668,"name":"eye.php","title":"eye.php","mimetype":"text\/plain","filetype":"html","pretty_type":"HTML","user":"U3P0NQW1M","editable":true,"size":5042,"mode":"snippet","is_external":false,"external_type":"","is_public":false,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T0QNWGW1X-F7ESKBJPQ\/eye.php","url_private_download":"https:\/\/files.slack.com\/files-pri\/T0QNWGW1X-F7ESKBJPQ\/download\/eye.php","permalink":"https:\/\/nsccit.slack.com\/files\/U3P0NQW1M\/F7ESKBJPQ\/eye.php","permalink_public":"https:\/\/slack-files.com\/T0QNWGW1X-F7ESKBJPQ-531459659d","edit_link":"https:\/\/nsccit.slack.com\/files\/U3P0NQW1M\/F7ESKBJPQ\/eye.php\/edit","preview":"\u003C!DOCTYPE html\u003E\n\u003Chtml lang=\"en\"\u003E\n\n\u003Chead\u003E\n    \u003Cmeta charset=\"utf-8\"\u003E","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-meta\"\u003E&lt;!DOCTYPE html&gt;\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-tag cm-bracket\"\u003E&lt;\u003C\/span\u003E\u003Cspan class=\"cm-tag\"\u003Ehtml\u003C\/span\u003E \u003Cspan class=\"cm-attribute\"\u003Elang\u003C\/span\u003E=\u003Cspan class=\"cm-string\"\u003E&quot;en&quot;\u003C\/span\u003E\u003Cspan class=\"cm-tag cm-bracket\"\u003E&gt;\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-tag cm-bracket\"\u003E&lt;\u003C\/span\u003E\u003Cspan class=\"cm-tag\"\u003Ehead\u003C\/span\u003E\u003Cspan class=\"cm-tag cm-bracket\"\u003E&gt;\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    \u003Cspan class=\"cm-tag cm-bracket\"\u003E&lt;\u003C\/span\u003E\u003Cspan class=\"cm-tag\"\u003Emeta\u003C\/span\u003E \u003Cspan class=\"cm-attribute\"\u003Echarset\u003C\/span\u003E=\u003Cspan class=\"cm-string\"\u003E&quot;utf-8&quot;\u003C\/span\u003E\u003Cspan class=\"cm-tag cm-bracket\"\u003E&gt;\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":117,"lines_more":112,"preview_is_truncated":true,"channels":[],"groups":[],"ims":["D5AU3J0LD","D7D89EHG8"],"comments_count":0};
...
<!-- slack-www-hhvm-0c81db6d715209ce3 / 2017-10-05 08:58:53 / v8d9896f1c25abf9d20514bebd9ba5e22a45b5b82 / B:H -->
